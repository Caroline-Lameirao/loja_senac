<?php
    ...
    ### manipulação dos dados de cliente na base ###
    ...
    function fnUpdateCliente($nome, $logradouro, $numero, $bairro, $cep, $codCidade, $codCliente)
    {
        ...
        $query .= "update endereco set nm_lgr = '{$logradouro}', nr_lgr = {$numero}, nm_bairro = '{$bairro}',  nr_cep = {$cep}, cod_cidade = {$codCidade} where cod_cli = {$codCliente}";
